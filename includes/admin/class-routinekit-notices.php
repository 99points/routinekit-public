...
class Routinekit_Notices {
	...
	public function render(): void {
		...
		if ( get_transient( 'routinekit_url_mismatch_notice' ) ) {
			delete_transient( 'routinekit_url_mismatch_notice' );
	...
	private function render_url_mismatch_notice(): void {
		$connect_url = esc_url( admin_url( 'admin.php?page=routinekit-settings' ) ) . '#cloud';
		?>
